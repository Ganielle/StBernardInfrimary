...
Public Class registrationnurse
#Region "Declares"
    Dim connection As New MySqlConnection
#End Region
    Private Sub registrationadmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
    ...
    Private Sub monthcombobox_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles monthcombobox.SelectedIndexChanged
    ...
    Private Sub searchtypebox_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles searchtypebox.SelectedIndexChanged
